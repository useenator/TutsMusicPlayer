...
public class Controls {
	...
	public static void nextControl(Context context) {
		...
		PlayerConstants.SONG_NEXT_HANDLER.sendMessage(PlayerConstants.SONG_NEXT_HANDLER.obtainMessage());
	...
	public static void previousControl(Context context) {
		...
		PlayerConstants.SONG_PREV_HANDLER.sendMessage(PlayerConstants.SONG_PREV_HANDLER.obtainMessage());
		PlayerConstants.SONG_NUMBER--;
		PlayerConstants.SONG_PAUSED = false;
	}
